...
# O CÓDIGO ACIMA PODE GERAR UM  ERRO DE DIVISÃO POR ZERO SE 
...
#     print(f"Erro de vtalor: Por favor, digite um número inteiro válido. {e} ou Erro: Não é possível dividir por zero. {e}")
